...
func TestParseFromYaml(t *testing.T) {
	...
	tcs := []struct {
	...
	}{
		{
			...
			in: `
            kind: tool
            name: mock-bigtablecreateinstance
            type: bigtable-create-instance
            source: my-bigtable-source
            description: some description
            `,
			want: server.ToolConfigs{
				"mock-bigtablecreateinstance": bigtablecreateinstance.Config{
		...
		},
		{
			...
			in: `
            kind: tool
            name: mock-bigtablecreateinstance-auth
            type: bigtable-create-instance
            source: my-bigtable-source
            description: some description
            authRequired: 
            ...
            `,
			want: server.ToolConfigs{
				"mock-bigtablecreateinstance-auth": bigtablecreateinstance.Config{
					ConfigBase: tools.ConfigBase{
						Name:         "mock-bigtablecreateinstance-auth",
						Description:  "some description",
