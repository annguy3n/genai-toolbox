...
func (t Tool) Invoke(ctx context.Context, resourceMgr tools.SourceProvider, params parameters.ParamValues, accessToken tools.AccessToken) (any, util.ToolboxError) {
	...
	views, err := client.Clusters(ctx, paramsMap["instance_id"].(string))
	if err != nil {
		return nil, util.NewClientServerError("failed to list clusters", http.StatusInternalServerError, err)
	}
	return views, nil
}
