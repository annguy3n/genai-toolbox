...
type SchemaList struct {
	...
	LogicalViews      []bigtable.LogicalViewInfo      `json:"logical_views"`
	MaterializedViews []bigtable.MaterializedViewInfo `json:"materialized_views"`
}
...
func (t Tool) Invoke(ctx context.Context, resourceMgr tools.SourceProvider, params parameters.ParamValues, accessToken tools.AccessToken) (any, util.ToolboxError) {
	...
	schemaList := SchemaList{
		Tables:            []TableSchema{},
		LogicalViews:      []bigtable.LogicalViewInfo{},
		MaterializedViews: []bigtable.MaterializedViewInfo{},
	}
	...
	if logicalViews != nil {
		schemaList.LogicalViews = logicalViews
	}
	...
	if materializedViews != nil {
		schemaList.MaterializedViews = materializedViews
	}
