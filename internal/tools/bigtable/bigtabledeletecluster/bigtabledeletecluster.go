...
func (t Tool) Invoke(ctx context.Context, resourceMgr tools.SourceProvider, params parameters.ParamValues, accessToken tools.AccessToken) (any, util.ToolboxError) {
	...
	err = client.DeleteCluster(ctx, paramsMap["instance_id"].(string), paramsMap["cluster_id"].(string))
	if err != nil {
		return nil, util.NewClientServerError("failed to delete cluster", http.StatusInternalServerError, err)
	}
