...
func (cfg Config) Initialize(context.Context) (tools.Tool, error) {
	...
	allParameters := parameters.Parameters{
		parameters.NewStringParameter("table_id", "The ID of the table to create", parameters.WithStringRequired(true)),
	}
...
func (t Tool) Invoke(ctx context.Context, resourceMgr tools.SourceProvider, params parameters.ParamValues, accessToken tools.AccessToken) (any, util.ToolboxError) {
	...
	err = client.CreateTable(ctx, paramsMap["table_id"].(string))
	if err != nil {
		return nil, util.NewClientServerError("failed to create table", http.StatusInternalServerError, err)
	}
