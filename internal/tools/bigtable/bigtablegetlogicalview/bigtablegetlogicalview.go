...
func (t Tool) Invoke(ctx context.Context, resourceMgr tools.SourceProvider, params parameters.ParamValues, accessToken tools.AccessToken) (any, util.ToolboxError) {
	...
	info, err := client.LogicalViewInfo(ctx, paramsMap["instance_id"].(string), paramsMap["logical_view_id"].(string))
	if err != nil {
		return nil, util.NewClientServerError("failed to get logical view info", http.StatusInternalServerError, err)
	}
	return info, nil
}
