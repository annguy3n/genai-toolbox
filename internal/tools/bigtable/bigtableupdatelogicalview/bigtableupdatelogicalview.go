...
func (cfg Config) Initialize(context.Context) (tools.Tool, error) {
	...
	allParameters := parameters.Parameters{
		...
		parameters.NewStringParameter("query", "The new logical view query", parameters.WithStringRequired(true)),
	}
...
func (t Tool) Invoke(ctx context.Context, resourceMgr tools.SourceProvider, params parameters.ParamValues, accessToken tools.AccessToken) (any, util.ToolboxError) {
	...
	err = client.UpdateLogicalView(ctx, paramsMap["instance_id"].(string), conf)
	if err != nil {
		return nil, util.NewClientServerError("failed to update logical view", http.StatusInternalServerError, err)
	}
