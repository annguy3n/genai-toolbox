...
func TestParseFromYaml(t *testing.T) {
	...
	tcs := []struct {
	...
	}{
		{
			...
			in: `
            kind: tool
            name: mock-bigtablelistlogicalviews
            type: bigtable-list-logical-views
            source: my-bigtable-source
            description: some description
            `,
			want: server.ToolConfigs{
				"mock-bigtablelistlogicalviews": bigtablelistlogicalviews.Config{
		...
		},
		{
			...
			in: `
            kind: tool
            name: mock-bigtablelistlogicalviews-auth
            type: bigtable-list-logical-views
            source: my-bigtable-source
            description: some description
            authRequired: 
            ...
            `,
			want: server.ToolConfigs{
				"mock-bigtablelistlogicalviews-auth": bigtablelistlogicalviews.Config{
					ConfigBase: tools.ConfigBase{
						Name:         "mock-bigtablelistlogicalviews-auth",
						Description:  "some description",
