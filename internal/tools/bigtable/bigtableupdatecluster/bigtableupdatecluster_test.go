...
func TestParseFromYaml(t *testing.T) {
	...
	tcs := []struct {
	...
	}{
		{
			...
			in: `
            kind: tool
            name: mock-bigtableupdatecluster
            type: bigtable-update-cluster
            source: my-bigtable-source
            description: some description
            `,
			want: server.ToolConfigs{
				"mock-bigtableupdatecluster": bigtableupdatecluster.Config{
		...
		},
		{
			...
			in: `
            kind: tool
            name: mock-bigtableupdatecluster-auth
            type: bigtable-update-cluster
            source: my-bigtable-source
            description: some description
            authRequired: 
            ...
            `,
			want: server.ToolConfigs{
				"mock-bigtableupdatecluster-auth": bigtableupdatecluster.Config{
					ConfigBase: tools.ConfigBase{
						Name:         "mock-bigtableupdatecluster-auth",
						Description:  "some description",
