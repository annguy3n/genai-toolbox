...
func (cfg Config) Initialize(context.Context) (tools.Tool, error) {
	...
	allParameters := parameters.Parameters{
		...
		parameters.NewIntParameter("serve_nodes", "The new number of nodes to allocate", parameters.WithIntRequired(true)),
	}
...
func (t Tool) Invoke(ctx context.Context, resourceMgr tools.SourceProvider, params parameters.ParamValues, accessToken tools.AccessToken) (any, util.ToolboxError) {
	...
	err = client.UpdateCluster(ctx, paramsMap["instance_id"].(string), paramsMap["cluster_id"].(string), int32(paramsMap["serve_nodes"].(int)))
	if err != nil {
		return nil, util.NewClientServerError("failed to update cluster", http.StatusInternalServerError, err)
	}
