...
func TestBigtableToolEndpoints(t *testing.T) {
	...
	_, _, _ = tests.InvokeMCPTool(t, "dummy-bigtable-get-table", map[string]any{"table_id": "bad"}, map[string]string{})
	...
	_, _, _ = tests.InvokeMCPTool(t, "dummy-bigtable-create-table", map[string]any{"table_id": "test", "column_families": []any{"cf1"}}, map[string]string{})
	_, _, _ = tests.InvokeMCPTool(t, "dummy-bigtable-delete-table", map[string]any{"table_id": "test"}, map[string]string{})
	_, _, _ = tests.InvokeMCPTool(t, "dummy-bigtable-update-table", map[string]any{"table_id": "test", "column_families": []any{"cf1"}}, map[string]string{})
	_, _, _ = tests.InvokeMCPTool(t, "dummy-bigtable-create-cluster", map[string]any{"cluster_id": "test", "location": "us-central1-a", "num_nodes": 1}, map[string]string{})
	_, _, _ = tests.InvokeMCPTool(t, "dummy-bigtable-delete-cluster", map[string]any{"cluster_id": "test"}, map[string]string{})
	_, _, _ = tests.InvokeMCPTool(t, "dummy-bigtable-update-cluster", map[string]any{"cluster_id": "test", "num_nodes": 1}, map[string]string{})
	_, _, _ = tests.InvokeMCPTool(t, "dummy-bigtable-create-instance", map[string]any{"instance_id": "test", "display_name": "test", "clusters": []any{map[string]any{"cluster_id": "test", "location": "us-central1-a", "num_nodes": 1}}}, map[string]string{})
	_, _, _ = tests.InvokeMCPTool(t, "dummy-bigtable-update-instance", map[string]any{"instance_id": "test", "display_name": "test", "clusters": []any{map[string]any{"cluster_id": "test", "location": "us-central1-a", "num_nodes": 1}}}, map[string]string{})
	_, _, _ = tests.InvokeMCPTool(t, "dummy-bigtable-delete-instance", map[string]any{"instance_id": "test"}, map[string]string{})
	_, _, _ = tests.InvokeMCPTool(t, "dummy-bigtable-create-logical-view", map[string]any{"logical_view_id": "test", "query": "SELECT 1"}, map[string]string{})
	_, _, _ = tests.InvokeMCPTool(t, "dummy-bigtable-update-logical-view", map[string]any{"logical_view_id": "test", "query": "SELECT 1"}, map[string]string{})
	_, _, _ = tests.InvokeMCPTool(t, "dummy-bigtable-delete-logical-view", map[string]any{"logical_view_id": "test"}, map[string]string{})
